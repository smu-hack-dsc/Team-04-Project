...
const ProductPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://13.212.68.5:5000/api/product/${productIdInt}/`)
      .then((response) => {
    ...
    axios
      .get(`http://13.212.68.5:5000/api/product_availability/${productIdInt}/`)
      .then((response) => {
  ...
  useEffect(() => {
    ...
    if (product) {
      ...
      if (token == null) {
        ...
        axios
          .get(
            "http://13.212.68.5:5000/api/size_recommender/" +
              userId +
              "/" +
              product["brand"] +
              "/" +
  ...
  const addToCart = (
    ...
    axios
      .post("http://13.212.68.5:5000/api/cart", productData)
      .then((response) => {
